...
<head>
    ...
    <style>
        ...
        .faq-question {
            background-color: rgba(0, 255, 250, 0.14);
            padding: 10px;

        }

        .faq-answer {
            background-color: rgb(255, 255, 255); /* or any other light color */
            padding: 10px;
        }
...
<div id="container" class="container-fluid" style="padding: 0px 50px; border-radius: 5px" >
    <div class="row" style="border-radius: 5px">
        <div style="background-color: #fcfcfc; padding: 30px; border-radius: 15px; margin-bottom: 125px;" class="col-md-12" s>
            ...
            <div class="faq-answer">
                <p>The cost of using our trip sharing service varies depending on several factors, including the distance of the trip, the number of passengers, and any additional services or amenities provided by the driver. Our platform allows drivers to set their own prices, so the exact cost can differ from one trip to another. When searching for available trips, you'll be able to see the price listed by each driver. It's important to note that our platform aims to provide affordable and competitive prices for both drivers and passengers. We encourage users to compare prices, read reviews, and choose the option that best suits their budget and preferences.</p>
            </div>
            <div class="faq-question">
            ...
            <div class="faq-question">
                <h3>Is there a border issue between North Cyprus and South Cyprus?</h3>
            </div>
            <div class="faq-answer">
                <p>Yes, there is a border issue between North Cyprus and South Cyprus. The island of Cyprus has been divided since 1974, resulting in the creation of two separate entities: the internationally recognized Republic of Cyprus in the south and the self-declared Turkish Republic of Northern Cyprus in the north. The border, commonly known as the "Green Line," runs through the capital city of Nicosia and restricts the movement of people and goods between the two regions.</p>
                <p>When planning your trip, it's important to be aware of the border situation and any travel restrictions that may be in place. Make sure to familiarize yourself with the necessary travel documents and requirements for crossing the border if you intend to travel between North Cyprus and South Cyprus.</p>
            </div>
